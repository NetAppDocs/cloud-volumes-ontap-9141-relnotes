...
https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.14.1P12[View the list of bugs fixed in the P10 patch^] (NetApp Support Site login required).
